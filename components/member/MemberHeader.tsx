            ...
            <div className="flex items-center space-x-3">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64">
                  ...
                  <DropdownMenuItem onClick={() => router.push('/member-dashboard/my-bookings')}>
                    <Calendar className="mr-2 h-4 w-4" />
                    Мои записи
                  </DropdownMenuItem>

                  <DropdownMenuItem onClick={() => router.push('/qr-code')}>
                    ...
                    <DropdownMenuLabel className="text-xs text-gray-500">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        ...
                        <div className="text-center p-2 bg-purple-50 rounded">
                          <div className="font-semibold text-purple-600">{stats.totalHours}ч</div>
                          <div className="text-gray-500">Часов</div>
                        </div>
                        <div className="text-center p-2 bg-orange-50 rounded">
                          <div className="font-semibold text-orange-600">{stats.daysLeft}д</div>
        ...
        <div className="lg:hidden bg-white border-b border-gray-200 shadow-lg animate-in slide-in-from-top duration-300">
          <div className="max-w-7xl mx-auto px-4 py-4">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg">
              <h4 className="text-sm font-medium text-gray-700 mb-2">Ваш прогресс</h4>
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-xs mb-1">
                    <span className="text-gray-600">Тренировки в месяце</span>
                    <span className="font-medium">{stats.completed}/20</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="font-medium">{stats.daysLeft} дней осталось</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
