// components/admin/products/AdvancedProductFilters.tsx
...
interface AdvancedProductFiltersProps {
  ...
  onPopularFilterChange: (value: string) => void;
  sortBy: string;
  sortOrder: 'asc' | 'desc';
...
export const AdvancedProductFilters = memo(function AdvancedProductFilters({
  searchTerm,
  onSearchChange,
  categoryFilter,
