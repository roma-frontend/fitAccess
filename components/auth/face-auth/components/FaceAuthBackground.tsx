// components/auth/face-auth/components/FaceAuthBackground.tsx
"use client";

import { motion } from "framer-motion";

export function FaceAuthBackground() {
  return (
    <>
      {/* Background Pattern */}
      ...
      />
      <motion.div
        className="absolute bottom-32 right-32 w-32 h-32 bg-indigo-200/40 rounded-full blur-xl"
        animate={{
          y: [0, 20, 0],
          scale: [1, 0.9, 1],
        }}
